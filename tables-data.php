        ...
        <nav class="navbar navbar-expand-sm navbar-default">
            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
					...
					<li>    <a href="estadisticas.php"> <i class="menu-icon ti-email"></i>Economicas </a>
                    </li>
    ...
    <div id="right-panel" class="right-panel">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <table id="bootstrap-data-table" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
										<?php
									$texto="SELECT max(a.fecha_lectura) vfecha, Bares.Nombre,a.MaquinaB,a.Raspberry,max(a.`R_total___ent`) entradas,max(a.`R_total___sal`) salidas FROM Bares , registros_v2 a, Rasberries WHERE  a.R_total___ent>0 and a.Raspberry=Rasberries.serial AND Rasberries.id_bar= Bares.id_bar  GROUP BY a.Raspberry";
									...
									{	 
											...
											<td><?php echo($record['vfecha']);?></td>
                                            <td><?php echo($record['Nombre']);?></td>
											<td><?php echo($record['MaquinaB']);?></td>
											<td><?php echo($record['Raspberry']); ?></td>
											<td><?php echo($record['entradas']);?></td>
											<td><?php echo($record['salidas']);?></td>
											<td>
												<a href="estadisticas.php?rasberry=<?php echo($record['Raspberry']); ?>"><i class="fa fa-bar-chart-o" title="Estadisticas"></i></a>&nbsp;
												<a href="tables-data-detalle.php?rasberry=<?php echo($record['Raspberry']); ?>"><i class="fa fa-search" title="Detalle Lecturas"></i></a>
        ...
        <footer class="site-footer">
            <div class="footer-inner bg-white">
                <div class="row">
                    <div class="col-sm-6">
                        Copyright &copy; 2021 Game4All
                    </div>
                    <div class="col-sm-6 text-right">
                        Designed by Talentum
                    </div>
                </div>
            </div>
        </footer>
