                        ...
                        <div class="page-header float-right">
                            <div class="page-title">
                                <ol class="breadcrumb text-right">
                                    ...
                                    <li><a href="tables-data.php">MaquinasB</a></li>
                                    <li class="active"><?php echo $_GET['rasberry'];?></li>
                                </ol>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <table id="bootstrap-data-table" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
										<?php
									$texto="SELECT fecha_lectura,Raspberry, `R_total___ent` entradas,`R_total___sal` salidas FROM registros_v2 WHERE  R_total___ent>0 and Raspberry='".$_GET['rasberry']."' ORDER BY id asc";
									...
									{	 
										    ?><tr>
                                            <td><?php echo($record['fecha_lectura']);?></td>
